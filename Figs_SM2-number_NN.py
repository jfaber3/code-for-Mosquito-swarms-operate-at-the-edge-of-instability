...
NN_count = np.linspace(1, 15, 15, dtype=int)
...
'''
ax1.axhline(y=DP_vis1, ls='dotted', color=clrs[1])
ax1.axhline(y=DP_vis2, ls='dotted', color=clrs[2])
ax1.axhline(y=DP_vis3, ls='dotted', color=clrs[3])
ax1.axhline(y=DP_vis4, ls='dotted', color=clrs[4])
ax1.axhline(y=DP_vis5, ls='dotted', color=clrs[5])
ax1.axhline(y=DP_vis6, ls='dotted', color=clrs[6])

ax2.axhline(y=DP_vis1, ls='dotted', color=clrs[1])
ax2.axhline(y=DP_vis2, ls='dotted', color=clrs[2])
ax2.axhline(y=DP_vis3, ls='dotted', color=clrs[3])
ax2.axhline(y=DP_vis4, ls='dotted', color=clrs[4])
ax2.axhline(y=DP_vis5, ls='dotted', color=clrs[5])
ax2.axhline(y=DP_vis6, ls='dotted', color=clrs[6])

ax3.axhline(y=DP_vis1, ls='dotted', color=clrs[1])
ax3.axhline(y=DP_vis2, ls='dotted', color=clrs[2])
ax3.axhline(y=DP_vis3, ls='dotted', color=clrs[3])
ax3.axhline(y=DP_vis4, ls='dotted', color=clrs[4])
ax3.axhline(y=DP_vis5, ls='dotted', color=clrs[5])
ax3.axhline(y=DP_vis6, ls='dotted', color=clrs[6])

ax4.axhline(y=DP_vis1, ls='dotted', color=clrs[1])
ax4.axhline(y=DP_vis2, ls='dotted', color=clrs[2])
ax4.axhline(y=DP_vis3, ls='dotted', color=clrs[3])
ax4.axhline(y=DP_vis4, ls='dotted', color=clrs[4])
ax4.axhline(y=DP_vis5, ls='dotted', color=clrs[5])
ax4.axhline(y=DP_vis6, ls='dotted', color=clrs[6])



ax1.axhline(y=DP_vis1_b, color=clrs[1])
ax1.axhline(y=DP_vis2_b, color=clrs[2])
ax1.axhline(y=DP_vis3_b, color=clrs[3])
ax1.axhline(y=DP_vis4_b, color=clrs[4])
ax1.axhline(y=DP_vis5_b, color=clrs[5])
ax1.axhline(y=DP_vis6_b, color=clrs[6])

ax2.axhline(y=DP_vis1_b, color=clrs[1])
ax2.axhline(y=DP_vis2_b, color=clrs[2])
ax2.axhline(y=DP_vis3_b, color=clrs[3])
ax2.axhline(y=DP_vis4_b, color=clrs[4])
ax2.axhline(y=DP_vis5_b, color=clrs[5])
ax2.axhline(y=DP_vis6_b, color=clrs[6])

ax3.axhline(y=DP_vis1_b, color=clrs[1])
ax3.axhline(y=DP_vis2_b, color=clrs[2])
ax3.axhline(y=DP_vis3_b, color=clrs[3])
ax3.axhline(y=DP_vis4_b, color=clrs[4])
ax3.axhline(y=DP_vis5_b, color=clrs[5])
ax3.axhline(y=DP_vis6_b, color=clrs[6])

ax4.axhline(y=DP_vis1_b, color=clrs[1])
ax4.axhline(y=DP_vis2_b, color=clrs[2])
ax4.axhline(y=DP_vis3_b, color=clrs[3])
ax4.axhline(y=DP_vis4_b, color=clrs[4])
ax4.axhline(y=DP_vis5_b, color=clrs[5])
ax4.axhline(y=DP_vis6_b, color=clrs[6])
'''
